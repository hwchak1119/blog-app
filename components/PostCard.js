...
function PostCard({ post }) {
  return (
    <div className="group cursor-pointer bg-white shadow-lg hover:shadow-2xl shadow-blue-900/50 transition duration-200 rounded-md p-0 lg:p-8 pb-12 mb-8">
      <div className="relative overflow-hidden shadow-md pb-80 mb-6">
        {post?.auther}
        <img
          src={post?.featuredImage.url}
          alt="post.title"
          className="object-top absolute h-80 w-full object-cover shadow-sm rounded-t-md lg:rounded-md"
        />
      </div>
